...
public class SimpleUserCommentServlet extends HttpServlet
{
    ...
    static String dest = "http://kdd.csd.uwo.ca:88/seeu/index.html";
	 ...
	 public void init() throws ServletException {	
		 ...
		 destname = getServletConfig().getInitParameter("redirect_destname");
    ...
    {		
		...
		try{
			...
			msg = "<html>"
					+ "<head>"
					+ "<title>Redirect to SEEU homepage</title>"
					+ "<meta http-equiv=\"refresh\" content=\"5; URL=" + dest + "\">"
					+ "<meta name=\"keywords\" content=\"automatic redirection\">"
					+ "</head>"
					+ "<body>"
					+ "<h>Thank you very much for your comments</h>.<br/><br/>"
					+ "<h>If your browser doesn't automatically go there within a few seconds, " 
					+ "you may want to go to "
					+ "<a href=\"" + dest + "\">"+destname+"</a>" 
					+ " manually.</h>"
					+ "</body>"
					+ "</html>";										
